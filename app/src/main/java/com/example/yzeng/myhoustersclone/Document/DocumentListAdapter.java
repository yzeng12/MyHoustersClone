...
public class DocumentListAdapter extends RecyclerView.Adapter<DocumentListAdapter.ProductListViewHolder> implements View.OnClickListener{
    private Context context;
    private List<DataBaseDocument> List;
    private OnItemClickListener onItemClickListener;

    public DocumentListAdapter(Context context, List<DataBaseDocument> List) {
