...
public class TenantSignUpFragment extends Fragment implements SignupInterface.FragmentView {

    Button buttonSignUp;
    SignupPresenter presenter;
    private static final String TAG = "TenantSignUpFragment";
    EditText editTextEmail, editLandlordTextEmail, editTextPassword, editTextPassword2;
    boolean flag;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        editLandlordTextEmail = view.findViewById(R.id.edit_landlord_email);
